...
// #include "native_client/src/trusted//linux_types.h"
...
int NaClNanosleep(struct nacl_abi_timespec const  *req,
  ...
  NaClLog(LOG_FATAL, "NaClNanosleep: not implemented yet\n");
  ...
  retval = ocall_nsleep(&host_req, host_remptr);
