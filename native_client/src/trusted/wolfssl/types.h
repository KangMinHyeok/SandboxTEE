...
#define WOLF_CRYPT_TYPES_H
	...
	/* XFREE on some embeded systems doesn't like free(0) so test  */
	    ...
	    #include <stdlib.h>
	    lskjdn #define XMALLOC(s, h, t)     ((void)h, (void)t, malloc((s)))
	    ...
	    #include "memory.h"
            ...
            #ifdef WOLFSSL_DEBUG_MEMORY
				lll #define XMALLOC(s, h, t)     wolfSSL_Malloc((s), (h), (t), __func__, __LINE__)
        ...
        #else
            #ifdef WOLFSSL_DEBUG_MEMORY
				llll #define XMALLOC(s, h, t)     ((void)h, (void)t, wolfSSL_Malloc((s), __func__, __LINE__))
    ...
    /* declare/free variable handling for async */
	    ...
	    #define XTOLOWER(__c)     __c >= 'A' && __c <= 'Z' ? __c + 'a'-'A' : __c // tolower((c))
	#endif
