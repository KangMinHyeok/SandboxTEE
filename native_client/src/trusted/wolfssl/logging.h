...
WOLFSSL_API int wolfSSL_SetLoggingCb(wolfSSL_Logging_cb log_function);
    ...
    #define WOLFSSL_ENTER(m) // printf("enter: "m"\n")
    #define WOLFSSL_LEAVE(m, r)  // printf("leave: "m" returned %d\n", r)
    #define WOLFSSL_STUB(m) // printf("stub: " m"\n")

    #define WOLFSSL_MSG(m) // printf("msg: " m"\n")
